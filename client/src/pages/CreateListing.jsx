...
const storeImage=async(file)=>{
  ...
  return (
    <main className='p-3 mt-4 max-w-4xl mx-auto gap-4'>
        <h1 className='text-3xl font-semibold text-center mt-16 my-7'>Create a Listing</h1>
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-2 flex-1'>
                ...
                <input type='text' placeholder='Contact' className='border p-3 rounded-lg' id='contact' required></input>
            ...
            <div className='flex gap-4 flex-col flex-1'>
                ...
                <div className='flex gap-4'>
                    ...
                    <button type='button' onClick={handleImageSubmit} className='p-3 font-bold text-green-700 border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>Upload</button>
                </div>
            </div>
        </form>
    </main>
